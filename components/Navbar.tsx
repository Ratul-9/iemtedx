...
export default function Navbar() {
  return (
    <nav className="w-auto bg-black text-white z-50 shadow-md">
      <div className="max-w-7xl ml-22 px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex space-x-3 mx-2 my-0 px-2 py-1 bg-[#E62B1E] rounded-sm ">
